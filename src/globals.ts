...
export const translations = {
	pl: {
		...
		dashboard_stats_lines: 'wysłanych linii kodu',
		dashboard_stats_chars: 'znaków',
		...
		popup_options_c_meta: 'Rozszerzenie:',
	...
	en: {
		...
		dashboard_stats_lines: 'lines submitted',
		dashboard_stats_chars: 'chars',
		...
		popup_options_c_meta: 'Extension:',
		popup_options_export: 'Export',
		popup_options_import: 'Import',
