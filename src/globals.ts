...
export const translations = {
	pl: {
		...
		home_search_placeholder: 'Wyszukaj zadanie po nazwie lub tagu',
		home_search_submit: 'Szukaj',
		home_search_noHints: 'Brak podpowiedzi',
		...
		popup_options_preferredLanguage: 'Preferowany język',
		popup_options_preferredLanguageInfo: 'będzie wybierany automatycznie przy zgłaszaniu rozwiązań',
		popup_options_preferredLanguageNone: 'brak',
		...
		popup_options_showProblemSolveCounts: 'Ilu rozwiązało zadanie',
		popup_options_showProblemSolveCountsInfo: 'w zakładce \'zadania\' konkursu, na podstawie rankingu',
		...
		popup_status_online: 'ONLINE',
		popup_status_offline: 'OFFLINE',
		popup_status_unknown: 'NIEZNANY',
		popup_status_loading: 'Ładowanie...',
		popup_status_apiUnavailable: 'API niedostępne',
		popup_status_downSuffix: ' (wywalił sie)',
		popup_status_crash_singular: 'awaria',
		popup_status_crash_plural: 'awarie',

		popup_options_whatsOnHome: 'Na stronie głównej',
		popup_options_whatsOnHome_status: 'status Szkopuła',
		popup_options_whatsOnHome_quickSettings: 'szybkie ustawienia',

		notes_title: 'Notatki do',
		notes_placeholder: 'Twoje notatki do tego zadania...',
		notes_hint_undo: 'ctrl+z działa!',
		notes_save: 'Zapisz',
		notes_saved: 'Zapisano!',
		notes_cleared: 'Wyczyszczono!',

		misc_feedback_button: 'Feedback do Utilsów',
		misc_inline_open_new_tab: 'Otwórz w nowej karcie',
		misc_inline_submit: 'Wyślij',
		misc_inline_close: 'Zamknij',
		misc_inline_show_statement: 'Pokaz treść',
		misc_code_counter_chars: 'Znaki',
		misc_code_counter_lines: 'Linie',

		ui_confirm_revealScore: 'Na pewno?',
		ui_pinned_empty: 'Brak przypiętych konkursów.',
		ui_pinned_header: 'Przypięte konkursy',
		ui_activity_header: 'Aktywność',
		ui_virtual_panel_title: 'Konkurs wirtualny',
		ui_virtual_panel_tasks: 'Zadania',
		ui_virtual_panel_noTasks: 'Brak zadań',
		archive_noTasksInGroup: 'Brak zadań w tej grupie :/',

		problems_solved_header: 'Rozwiązane',
		problems_solved_headerTooltip: 'Ilu uczestników rankingu zdobyło komplet punktów / ilu ma jakikolwiek wynik',
		problems_solved_tooltipFull: 'z kompletem punktów',
		problems_solved_tooltipAny: 'z jakimkolwiek wynikiem w rankingu',
		problems_solved_tooltipPartial: 'Dane częściowe - ranking jest za długi, żeby wczytać go w całości.',
		problems_solved_noData: 'Brak tego zadania w rankingu.',
	...
	en: {
		...
		home_search_placeholder: 'Search problems by name or tag',
		home_search_submit: 'Search',
		home_search_noHints: 'No suggestions',
		...
		popup_options_preferredLanguage: 'Preferred language',
		popup_options_preferredLanguageInfo: 'will be selected automatically',
		popup_options_preferredLanguageNone: 'none',
		...
		popup_options_showProblemSolveCounts: 'Solve counts',
		popup_options_showProblemSolveCountsInfo: 'in a contest\'s \'problems\' tab, based on the ranking',
		...
		popup_status_loading: 'Loading...',
		popup_status_apiUnavailable: 'API unavailable',
		popup_status_downSuffix: ' (down)',
		popup_status_crash_singular: 'crash',
		popup_status_crash_plural: 'crashes',

		popup_options_whatsOnHome: 'On home',
		popup_options_whatsOnHome_status: 'Szkopul status',
		popup_options_whatsOnHome_quickSettings: 'quick settings',

		notes_title: 'Notes for',
		notes_placeholder: 'Your notes for this task...',
		notes_hint_undo: 'ctrl+z works!',
		notes_save: 'Save',
		notes_saved: 'Saved!',
		notes_cleared: 'Cleared!',

		misc_feedback_button: 'Utils feedback',
		misc_inline_open_new_tab: 'Open in new tab',
		misc_inline_submit: 'Submit',
		misc_inline_close: 'Close',
		misc_inline_show_statement: 'Show statement',
		misc_code_counter_chars: 'Chars',
		misc_code_counter_lines: 'Lines',

		ui_confirm_revealScore: 'Are you sure?',
		ui_pinned_empty: 'No pinned contests yet.',
		ui_pinned_header: 'Pinned contests',
		ui_activity_header: 'Activity',
		ui_virtual_panel_title: 'Virtual contest',
		ui_virtual_panel_tasks: 'Tasks',
		ui_virtual_panel_noTasks: 'No tasks',
		archive_noTasksInGroup: 'No tasks in this group lol',

		problems_solved_header: 'Solved',
		problems_solved_headerTooltip: 'How many people in the ranking got a full score / how many have any result',
		problems_solved_tooltipFull: 'with a full score',
		problems_solved_tooltipAny: 'with any result in the ranking',
		problems_solved_tooltipPartial: 'Partial data - the ranking is too long to be read in full.',
		problems_solved_noData: 'This problem is not in the ranking.',
