...
render(
	html`
        ...
        <details style="width: 100%; display: flex; flex-direction: column;">
            ...
            <div style="width: 100%; display: flex; flex-direction: column; align-items: center;">
                <div class="form-check form-switch switch-full d-flex align-items-center justify-content-between">
                    <label for="virtualBlockOtherSubpagesOption"
                           class="mb-0 form-check-label">${ t('popup_virtual_blockOtherSubpages') }</label>
            ...
            <div style="width: 100%; display: flex; flex-direction: column; align-items: center;">
                <div class="form-check form-switch switch-full d-flex align-items-center justify-content-between">
                    <label for="virtualHideScoresOption"
                           class="mb-0 form-check-label">${ t('popup_options_hideScores') }</label>
                    <div class="form-check form-switch m-0">
        ...
        <div class="d-flex gap-2"
             style="width: 100%; display: flex; justify-content: center; align-items: center; margin-top: 5px;">
...
render(
	html`
        ...
        <button id="btn-stopVirtual" type="button" class="btn btn-danger b" style="margin-top: 10px;">
            ${ t('popup_virtual_running_stop') }
        </button>
...
render(
	html`
        ...
        <div class="form-check form-switch switch-full d-flex align-items-center justify-content-between"
             style="min-height: auto;">
            <label for="hideRulesTabOption"
                   class="mb-0 form-check-label">${ t('popup_options_hideRulesTab') }</label>
            <div class="form-check form-switch m-0">
        ...
        <input id="input-importDataFile" type="file" accept="application/json,.json"
        ...
        <div id="popup-data-notice"
             style="display: none; width: 80%; margin-top: 6px; padding: 6px; border-radius: 6px; font-size: 12px; text-align: center; background: #2b3035;"></div>

        <div id="popup-confirm"
             style="display: none; width: 88%; margin-top: 6px; padding: 8px; border-radius: 8px; background: #2b3035; border: 1px solid #40464d;">
            <div id="popup-confirm-message" style="font-size: 12px; margin-bottom: 8px;"></div>
            <div style="display: flex; gap: 6px; justify-content: flex-end;">
                <button id="popup-confirm-cancel" type="button" class="btn btn-secondary" style="padding: 4px 8px;">
                    ${ t('popup_common_cancel') }
                </button>
                <button id="popup-confirm-accept" type="button" class="btn btn-danger" style="padding: 4px 8px;">
                    ${ t('popup_common_confirm') }
                </button>
            </div>
        </div>
